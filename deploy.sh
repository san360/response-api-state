...
###############################################################################
# deploy.sh — Deploy 3 Azure OpenAI instances and populate .env
###############################################################################
...
echo "============================================================"
echo "  Deploying Azure OpenAI Instances for Stateless API Test"
echo "============================================================"
...
INSTANCE1_NAME=$(az deployment sub show --name "$DEPLOYMENT_NAME" --query "properties.outputs.instance1Name.value" -o tsv)
INSTANCE2_NAME=$(az deployment sub show --name "$DEPLOYMENT_NAME" --query "properties.outputs.instance2Name.value" -o tsv)
INSTANCE3_NAME=$(az deployment sub show --name "$DEPLOYMENT_NAME" --query "properties.outputs.instance3Name.value" -o tsv)
